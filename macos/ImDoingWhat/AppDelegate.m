...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"ImDoingWhat"];
...
#if DEBUG
    sourceURL = [NSURL URLWithString:@"http://localhost:9988/index.macos.bundle?platform=macos&dev=true"];
#else
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit ImDoingWhat" action:@selector(terminate:) keyEquivalent:@"q"];
